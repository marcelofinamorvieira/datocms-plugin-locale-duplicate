    ...
    <Canvas ctx={ctx}>
        ...
        <Form style={{ maxWidth: '800px', width: '100%' }}>
          <Section title="Mass Locale Duplication">
            ...
            <div style={{ 
              ...
              <p style={{ margin: '0 0 var(--spacing-s) 0' }}>
              ...
              <div style={{
                ...
                borderLeft: '3px solid var(--orange-color, #ff9900)',
                ...
                <p style={{ 
                  ...
                  <span style={{ marginRight: 'var(--spacing-s)' }}>⚠️</span>
                  Warning
                </p>
                <ul style={{ 
                  margin: '0',
      ...
      {isProcessing && (
        <div style={{
          ...
          <div className={styles.progressContainer} style={{ maxWidth: '800px', width: '100%' }}>
      ...
      {showSummary && (
        <div style={{
          ...
          <div style={{ maxWidth: '800px', width: '100%', padding: 'var(--spacing-m)' }}>
          <h2 style={{ 
